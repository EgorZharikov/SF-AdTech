        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="{{ url('/dashboard') }}" class="brand-link">
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu"
                        ...
                        <li class="nav-item"> <a href="{{route('dashboard.advertiser.profile')}}" class="nav-link"> <i
                                    class="nav-icon bi bi-person-fill" style="font-size: 1.3rem; color: cornflowerblue;"></i>
                                <p>Profile</p>
                            </a></li>
                        <li class="nav-item"> <a href="{{route('dashboard.advertiser.offers')}}" class="nav-link"> <i
                                    class="nav-icon bi bi-arrow-left-right"
                                    style="font-size: 1.3rem; color: cornflowerblue;"></i>
                                <p>Offers</p>
                            </a></li>
                        <li class="nav-item"> <a href="{{route('dashboard.advertiser.statistics')}}" class="nav-link"> <i
                                    class="nav-icon bi bi-table" style="font-size: 1.3rem; color: cornflowerblue;"></i>
                                <p>Statistics</p>
                            </a></li>
                            <li class="nav-item"> <a href="{{route('dashboard.advertiser.wallet')}}" class="nav-link"> <i
